...
#setwd("/Volumes/GoogleDrive/Mi unidad/MannKendall")

#
MK_pvalue<-raster("PrecipitacionCNRMCM5_rcp85_MK_tau_0_05.tif")
...
MK_pvalue<-raster("PrecipitacionGFDL_CM3_rcp85_MK_tau_0_05.tif")
names(MK_pvalue)<-"MK_p"
...
MK_pvalue<-raster("PrecipitacionHADGEM2_ES_rcp85_MK_tau_0_05.tif")
names(MK_pvalue)<-"MK_p"
...
MK_pvalue<-raster("PrecipitacionMPI_ESM_LR_rcp85_MK_tau_0_05.tif")
names(MK_pvalue)<-"MK_p"
...
ggsave("ppt_graficas/PC_rcp85.jpg", dpi = 300)
...
ggsave("ppt_graficas/LT_rcp85.jpg", dpi = 300)
...
ggsave("ppt_graficas/TC_rcp85.jpg", dpi = 300)
...
ggsave("ppt_graficas/MM_rcp85.jpg", dpi = 300)
...
ggsave("ppt_graficas/MN_rcp85.jpg", dpi = 300)
...
ggsave("ppt_graficas/J_rcp85.jpg", dpi = 300)
...
ggsave("ppt_graficas/SSPM_rcp85.jpg", dpi = 300)
...
ggsave("ppt_graficas/C1857_rcp85.jpg", dpi = 300)
...
ggsave("ppt_graficas/CS_rcp85.jpg", dpi = 300)
...
ggsave("ppt_graficas/SO_rcp85.jpg", dpi = 300)
...
ggsave("ppt_graficas/EV_rcp85.jpg", dpi = 300)
...
ggsave("ppt_graficas/CAD_rcp85.jpg", dpi = 300)
...
ggsave("ppt_graficas/M_rcp85.jpg", dpi = 300)
