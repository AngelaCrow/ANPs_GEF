...
rm(v_anual3,anual3, va_3,p3ETPp)
#------------CLIMATICAS ANUAL "rcp45_2015-2039"
v_anual4<-list.files(path="E:/UniAtmos_P3/UniAtmosAngela/CNRMCM5_rcp85_2015-2039_bio/", pattern='*.tif$', full.names=TRUE)
anual4<-stack(v_anual4[2:20])
bio.p4<-c("p4bio_CNRMCM5_rcp85_01","p4bio_CNRMCM5_rcp85_10", "p4bio_CNRMCM5_rcp85_11","p4bio_CNRMCM5_rcp85_12",
          "p4bio_CNRMCM5_rcp85_13","p4bio_CNRMCM5_rcp85_14","p4bio_CNRMCM5_rcp85_15","p4bio_CNRMCM5_rcp85_16",
          "p4bio_CNRMCM5_rcp85_17","p4bio_CNRMCM5_rcp85_18", "p4bio_CNRMCM5_rcp85_19","p4bio_CNRMCM5_rcp85_02",
...
p4ETPf<-raster("E:/UniAtmos_P3/UniAtmosAngela/CNRMCM5_rcp85_2015-2039_AET_ETP/ETPf.tif")
#plot(p4ETPf)
...
rm(v_anual4,anual4, va_4,p4ETPf,bio.p4)
#------------CLIMATICAS ANUAL "rcp45_2045-2069"
v_anual5<-list.files(path="E:/UniAtmos_P3/UniAtmosAngela/CNRMCM5_rcp85_2045-2069_bio/", pattern='*.tif$', full.names=TRUE)
anual5<-stack(v_anual5[2:20])
bio.p5<-c("p5bio_CNRMCM5_rcp85_01","p5bio_CNRMCM5_rcp85_10", "p5bio_CNRMCM5_rcp85_11","p5bio_CNRMCM5_rcp85_12",
          "p5bio_CNRMCM5_rcp85_13","p5bio_CNRMCM5_rcp85_14","p5bio_CNRMCM5_rcp85_15","p5bio_CNRMCM5_rcp85_16",
          "p5bio_CNRMCM5_rcp85_17","p5bio_CNRMCM5_rcp85_18", "p5bio_CNRMCM5_rcp85_19","p5bio_CNRMCM5_rcp85_02",
...
p5ETPp<-raster("E:/UniAtmos_P3/UniAtmosAngela/CNRMCM5_rcp85_2045-2069_AET_ETP/ETPf.tif")
#plot(p4ETPp)
...
rm(v_anual5,anual5, va_5,p5ETPp)
#------------CLIMATICAS ANUAL "rcp45_2075-2099"
v_anual6<-list.files(path="E:/UniAtmos_P3/UniAtmosAngela/CNRMCM5_rcp85_2075-2099_bio/", pattern='*.tif$', full.names=TRUE)
anual6<-stack(v_anual6[2:20])
names(anual6)
bio.p6<-c("p6bio_CNRMCM5_rcp85_01","p6bio_CNRMCM5_rcp85_10", "p6bio_CNRMCM5_rcp85_11","p6bio_CNRMCM5_rcp85_12",
          "p6bio_CNRMCM5_rcp85_13","p6bio_CNRMCM5_rcp85_14","p6bio_CNRMCM5_rcp85_15","p6bio_CNRMCM5_rcp85_16",
...
p6ETPp<-raster("E:/UniAtmos_P3/UniAtmosAngela/CNRMCM5_rcp85_2075-2099_AET_ETP/ETPf.tif")
#plot(p6ETPp)
...
anpvar2<- as.data.frame(extract(variables2, coor))
anp_var2<-cbind(anp_p, anpvar2, Periodo="1950-1979", MGC ="CNRMCM5 RCP 8.5")
names(anp_var2)
anpvar3<- as.data.frame(extract(variables3, coor))
anp_var3<-cbind(anp_p, anpvar3, Periodo="1980-2009",MGC ="CNRMCM5 RCP 8.5")
names(anp_var3)
anpvar4<- as.data.frame(extract(variables4, coor))
anp_var4<-cbind(anp_p, anpvar4, Periodo="2015-2039", MGC ="CNRMCM5 RCP 8.5")
names(anp_var4)
anpvar5<- as.data.frame(extract(variables5, coor))
anp_var5<-cbind(anp_p, anpvar5, Periodo="2045-2069", MGC ="CNRMCM5 RCP 8.5")
names(anp_var5)
anpvar6<- as.data.frame(extract(variables6, coor))
anp_var6<-cbind(anp_p, anpvar6, Periodo="2075-2099", MGC ="CNRMCM5 RCP 8.5")
names(anp_var6)
...
head(anp_anual)
dir.create("bases")
write.csv(anp_anual, "bases/CNRMCM5_rcp85anp_anual_g.csv",fileEncoding = "UTF-8")
rm(variables2,variables3,variables4, variables5, variables6, anp_var2,
   anp_var3,anp_var4,anp_var5,anp_var6,anpvar2, anpvar3,anpvar4,anpvar5,anpvar6,
   bio.p4,bio.p5,bio.p6)
...
#Unir base con variables
#anpevom2<-cbind(anp_p,anp_evom2, Periodo="1950-1979", Variable="Evotranspiracion", MGC ="CNRMCM5 RCP 8.5")
anptmax2<-cbind(anp_p,anp_tmax2, Periodo="1950-1979", Variable="Tmax", MGC ="CNRMCM5 RCP 8.5")
anptmin2<-cbind(anp_p,anp_tmin2, Periodo="1950-1979", Variable="Tmin", MGC ="CNRMCM5 RCP 8.5")
anptpro2<-cbind(anp_p,anp_tpro2, Periodo="1950-1979", Variable="Tpro", MGC ="CNRMCM5 RCP 8.5")
anpprec2<-cbind(anp_p,anp_prec2, Periodo="1950-1979", Variable="Prec", MGC ="CNRMCM5 RCP 8.5")
names(anpprec2)
...
#Unir base con variables
#anpevom3<-cbind(anp_p,anp_evom3, Periodo="1980-2009", Variable="Evotranspiracion", MGC ="CNRMCM5 RCP 8.5")
anptmax3<-cbind(anp_p,anp_tmax3, Periodo="1980-2009", Variable="Tmax", MGC ="CNRMCM5 RCP 8.5")
names(anptmax3)
anptmin3<-cbind(anp_p,anp_tmin3, Periodo="1980-2009", Variable="Tmin", MGC ="CNRMCM5 RCP 8.5")
names(anptmin3)
anptpro3<-cbind(anp_p,anp_tpro3, Periodo="1980-2009", Variable="Tpro", MGC ="CNRMCM5 RCP 8.5")
names(anptpro3)
anpprec3<-cbind(anp_p,anp_prec3, Periodo="1980-2009", Variable="Prec", MGC ="CNRMCM5 RCP 8.5")
names(anpprec3)
...
tmax4<-stack(Sys.glob("E:/UniAtmos_P3/UniAtmosAngela/CNRMCM5_rcp85_2015-2039_tmax/*p4*.tif"))
plot(tmax4)

tmin4<-stack(Sys.glob("E:/UniAtmos_P3/UniAtmosAngela/CNRMCM5_rcp85_2015-2039_tmin/*p4*.tif"))
plot(tmin4)

tpro4<-stack(Sys.glob("E:/UniAtmos_P3/UniAtmosAngela/CNRMCM5_rcp85_2015-2039_tprom/*p4*.tif"))
plot(tpro4)

prec4<-stack(Sys.glob("E:/UniAtmos_P3/UniAtmosAngela/CNRMCM5_rcp85_2015-2039_prec/*p4*.tif"))
plot(prec4)
...
#Unir base con variables
#anpevom4<-cbind(anp_p,anp_evom4, Periodo="2015-2039", Variable="Evotranspiracion")
anptmax4<-cbind(anp_p,anp_tmax4, Periodo="2015-2039", Variable="Tmax", MGC ="CNRMCM5 RCP 8.5")
anptmin4<-cbind(anp_p,anp_tmin4, Periodo="2015-2039", Variable="Tmin", MGC ="CNRMCM5 RCP 8.5")
anptpro4<-cbind(anp_p,anp_tpro4, Periodo="2015-2039", Variable="Tpro", MGC ="CNRMCM5 RCP 8.5")
anpprec4<-cbind(anp_p,anp_prec4, Periodo="2015-2039", Variable="Prec", MGC ="CNRMCM5 RCP 8.5")
names(anpprec4)
...
tmax5<-stack(Sys.glob(path="E:/UniAtmos_P3/UniAtmosAngela/CNRMCM5_rcp85_2045-2069_tmax/*p5*.tif"))
plot(tmax5)

tmin5<-stack(Sys.glob(path="E:/UniAtmos_P3/UniAtmosAngela/CNRMCM5_rcp85_2045-2069_tmin/*p5*.tif"))
plot(tmin5)

tpro5<-stack(Sys.glob(path="E:/UniAtmos_P3/UniAtmosAngela/CNRMCM5_rcp85_2045-2069_tprom/*p5*.tif"))
plot(tpro5)

prec5<-stack(Sys.glob(path="E:/UniAtmos_P3/UniAtmosAngela/CNRMCM5_rcp85_2045-2069_prec/*p5*.tif"))
plot(prec5)
...
#Unir base con variables
#anpevom4<-cbind(anp_p,anp_evom4, Periodo="2045-2069", Variable="Evotranspiracion")
anptmax5<-cbind(anp_p,anp_tmax5, Periodo="2045-2069", Variable="Tmax", MGC ="CNRMCM5 RCP 8.5")
anptmin5<-cbind(anp_p,anp_tmin5, Periodo="2045-2069", Variable="Tmin", MGC ="CNRMCM5 RCP 8.5")
anptpro5<-cbind(anp_p,anp_tpro5, Periodo="2045-2069", Variable="Tpro", MGC ="CNRMCM5 RCP 8.5")
anpprec5<-cbind(anp_p,anp_prec5, Periodo="2045-2069", Variable="Prec", MGC ="CNRMCM5 RCP 8.5")
names(anpprec5)
...
tmax6<-stack(Sys.glob(path="E:/UniAtmos_P3/UniAtmosAngela/CNRMCM5_rcp85_2075-2099_tmax/*p6*.tif"))
plot(tmax6)

tmin6<-stack(Sys.glob(path="E:/UniAtmos_P3/UniAtmosAngela/CNRMCM5_rcp85_2075-2099_tmin/*p6*.tif"))
plot(tmin6)

tpro6<-stack(Sys.glob(path="E:/UniAtmos_P3/UniAtmosAngela/CNRMCM5_rcp85_2075-2099_tprom/*p6*.tif"))
plot(tpro6)

prec6<-stack(Sys.glob(path="E:/UniAtmos_P3/UniAtmosAngela/CNRMCM5_rcp85_2075-2099_prec/*p6*.tif"))
plot(prec6)
...
#Unir base con variables
#anpevom6<-cbind(anp_p,anp_evom6, Periodo="2075-2099", Variable="Evotranspiracion")
anptmax6<-cbind(anp_p,anp_tmax6, Periodo="2075-2099", Variable="Tmax", MGC ="CNRMCM5 RCP 8.5")
anptmin6<-cbind(anp_p,anp_tmin6, Periodo="2075-2099", Variable="Tmin", MGC ="CNRMCM5 RCP 8.5")
anptpro6<-cbind(anp_p,anp_tpro6, Periodo="2075-2099", Variable="Tpro", MGC ="CNRMCM5 RCP 8.5")
anpprec6<-cbind(anp_p,anp_prec6, Periodo="2075-2099", Variable="Prec", MGC ="CNRMCM5 RCP 8.5")
names(anpprec6)
...
write.csv(mes, "bases/CNRMCM5_rcp85anp_mes_g.csv", fileEncoding = "UTF-8")
