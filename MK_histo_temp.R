...
#
MK_pvalue<-raster("TpromedioCNRMCM5_rcp85_MK_tau.tif")
...
MK_pvalue<-raster("TpromedioGFDL_CM3_rcp85_MK_tau.tif")
names(MK_pvalue)<-"MK_p"
...
MK_pvalue<-raster("TpromedioHADGEM2_ES_rcp85_MK_tau.tif")
names(MK_pvalue)<-"MK_p"
...
MK_pvalue<-raster("TpromedioMPI_ESM_LR_rcp85_MK_tau.tif")
names(MK_pvalue)<-"MK_p"
...
ggsave("tmean_graficas/PC_rcp85.jpg", dpi = 300)
...
ggsave("tmean_graficas/LT_rcp85.jpg", dpi = 300)
...
ggsave("tmean_graficas/TC_rcp85.jpg", dpi = 300)
...
ggsave("tmean_graficas/MM_rcp85.jpg", dpi = 300)
...
ggsave("tmean_graficas/MN_rcp85.jpg", dpi = 300)
...
ggsave("tmean_graficas/J_rcp85.jpg", dpi = 300)
...
ggsave("tmean_graficas/SSPM_rcp85.jpg", dpi = 300)
...
ggsave("tmean_graficas/C1857_rcp85.jpg", dpi = 300)
...
ggsave("tmean_graficas/CS_rcp85.jpg", dpi = 300)
...
ggsave("tmean_graficas/SO_rcp85.jpg", dpi = 300)
...
ggsave("tmean_graficas/EV_rcp85.jpg", dpi = 300)
...
ggsave("tmean_graficas/CAD_rcp85.jpg", dpi = 300)
...
ggsave("tmean_graficas/M_rcp85.jpg", dpi = 300)
