...
#TMAXIMA####
#CNRMCM5
tmax2 <-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMaximaCNRMCM5_rcp45/*p2tmax*.rst"))
...
tmax3<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMaximaCNRMCM5_rcp45/*p3tmax*.rst"))
...
tmax4<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMaximaCNRMCM5_rcp45/*p4tmax*.rst"))
...
tmax5<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMaximaCNRMCM5_rcp45/*p5tmax*.rst"))
...
tmax6<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMaximaCNRMCM5_rcp45/*p6tmax*.rst"))
...
tmax4<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMaximaGFDL_CM3_rcp45/*p4tmax*.rst"))
anp_tmax4 <- as.data.frame(raster::extract(tmax4, coor))
names(anp_tmax4)
colnames(anp_tmax4)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmax5<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMaximaGFDL_CM3_rcp45/*p5tmax*.rst"))
anp_tmax5 <- as.data.frame(raster::extract(tmax5, coor))
names(anp_tmax5)
colnames(anp_tmax5)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmax6<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMaximaGFDL_CM3_rcp45/*p6tmax*.rst"))
anp_tmax6 <- as.data.frame(raster::extract(tmax6, coor))
names(anp_tmax6)
colnames(anp_tmax6)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmax4<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMaximaHADGEM2_ES_rcp45/*p4tmax*.rst"))
anp_tmax4 <- as.data.frame(raster::extract(tmax4, coor))
names(anp_tmax4)
colnames(anp_tmax4)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmax5<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMaximaHADGEM2_ES_rcp45/*p5tmax*.rst"))
anp_tmax5 <- as.data.frame(raster::extract(tmax5, coor))
names(anp_tmax5)
colnames(anp_tmax5)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmax6<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMaximaHADGEM2_ES_rcp45/*p6tmax*.rst"))
anp_tmax6 <- as.data.frame(raster::extract(tmax6, coor))
names(anp_tmax6)
colnames(anp_tmax6)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmax4<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMaximaMPI_ESM_LR_rcp45/*p4tmax*.rst"))
anp_tmax4 <- as.data.frame(raster::extract(tmax4, coor))
names(anp_tmax4)
colnames(anp_tmax4)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmax5<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMaximaMPI_ESM_LR_rcp45/*p5tmax*.rst"))
anp_tmax5 <- as.data.frame(raster::extract(tmax5, coor))
names(anp_tmax5)
colnames(anp_tmax5)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmax6<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMaximaMPI_ESM_LR_rcp45/*p6tmax*.rst"))
anp_tmax6 <- as.data.frame(raster::extract(tmax6, coor))
names(anp_tmax6)
colnames(anp_tmax6)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
#TMINIMA####
#CNRMCM5
tmin2 <-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMinimaCNRMCM5_rcp45/*p2tmin*.rst"))
...
tmin3<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMinimaCNRMCM5_rcp45/*p3tmin*.rst"))
...
tmin4<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMinimaCNRMCM5_rcp45/*p4tmin*.rst"))
...
tmin5<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMinimaCNRMCM5_rcp45/*p5tmin*.rst"))
...
tmin6<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMinimaCNRMCM5_rcp45/*p6tmin*.rst"))
...
tmin4<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMinimaGFDL_CM3_rcp45/*p4tmin*.rst"))
anp_tmin4 <- as.data.frame(raster::extract(tmin4, coor))
names(anp_tmin4)
colnames(anp_tmin4)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmin5<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMinimaGFDL_CM3_rcp45/*p5tmin*.rst"))
anp_tmin5 <- as.data.frame(raster::extract(tmin5, coor))
names(anp_tmin5)
colnames(anp_tmin5)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmin6<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMinimaGFDL_CM3_rcp45/*p6tmin*.rst"))
anp_tmin6 <- as.data.frame(raster::extract(tmin6, coor))
names(anp_tmin6)
colnames(anp_tmin6)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmin4<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMinimaHADGEM2_ES_rcp45/*p4tmin*.rst"))
anp_tmin4 <- as.data.frame(raster::extract(tmin4, coor))
names(anp_tmin4)
colnames(anp_tmin4)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmin5<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMinimaHADGEM2_ES_rcp45/*p5tmin*.rst"))
anp_tmin5 <- as.data.frame(raster::extract(tmin5, coor))
names(anp_tmin5)
colnames(anp_tmin5)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmin6<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMinimaHADGEM2_ES_rcp45/*p6tmin*.rst"))
anp_tmin6 <- as.data.frame(raster::extract(tmin6, coor))
names(anp_tmin6)
colnames(anp_tmin6)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmin4<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMinimaMPI_ESM_LR_rcp45/*p4tmin*.rst"))
anp_tmin4 <- as.data.frame(raster::extract(tmin4, coor))
names(anp_tmin4)
colnames(anp_tmin4)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmin5<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMinimaMPI_ESM_LR_rcp45/*p5tmin*.rst"))
anp_tmin5 <- as.data.frame(raster::extract(tmin5, coor))
names(anp_tmin5)
colnames(anp_tmin5)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmin6<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TMinimaMPI_ESM_LR_rcp45/*p6tmin*.rst"))
anp_tmin6 <- as.data.frame(raster::extract(tmin6, coor))
names(anp_tmin6)
colnames(anp_tmin6)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
#TPROMEDIO####
tmean2 <-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TPromedioCNRMCM5_rcp45/*p2tmean*.rst"))
...
tmean3<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TPromedioCNRMCM5_rcp45/*p3tmean*.rst"))
...
tmean4<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TPromedioCNRMCM5_rcp45/*p4tmean*.rst"))
...
tmean5<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TPromedioCNRMCM5_rcp45/*p5tmean*.rst"))
...
tmean6<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TPromedioCNRMCM5_rcp45/*p6tmean*.rst"))
...
tmean4<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TPromedioGFDL_CM3_rcp45/*p4tprom*.rst"))
anp_tmean4 <- as.data.frame(raster::extract(tmean4, coor))
names(anp_tmean4)
colnames(anp_tmean4)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                        "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmean5<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TPromedioGFDL_CM3_rcp45/*p5tprom*.rst"))
anp_tmean5 <- as.data.frame(raster::extract(tmean5, coor))
names(anp_tmean5)
colnames(anp_tmean5)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                        "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmean6<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TPromedioGFDL_CM3_rcp45/*p6tprom*.rst"))
anp_tmean6 <- as.data.frame(raster::extract(tmean6, coor))
names(anp_tmean6)
colnames(anp_tmean6)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                        "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmean4<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TPromedioHADGEM2_ES_rcp45/*p4tprom*.rst"))
anp_tmean4 <- as.data.frame(raster::extract(tmean4, coor))
names(anp_tmean4)
colnames(anp_tmean4)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                        "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmean5<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TPromedioHADGEM2_ES_rcp45/*p5tprom*.rst"))
anp_tmean5 <- as.data.frame(raster::extract(tmean5, coor))
names(anp_tmean5)
colnames(anp_tmean5)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                        "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmean6<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TPromedioHADGEM2_ES_rcp45/*p6tprom*.rst"))
anp_tmean6 <- as.data.frame(raster::extract(tmean6, coor))
names(anp_tmean6)
colnames(anp_tmean6)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                        "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmean4<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TPromedioMPI_ESM_LR_rcp45/*p4Tmean*.rst"))
anp_tmean4 <- as.data.frame(raster::extract(tmean4, coor))
names(anp_tmean4)
colnames(anp_tmean4)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                        "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmean5<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TPromedioMPI_ESM_LR_rcp45/*p5Tmean*.rst"))
anp_tmean5 <- as.data.frame(raster::extract(tmean5, coor))
names(anp_tmean5)
colnames(anp_tmean5)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                        "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
tmean6<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/TPromedioMPI_ESM_LR_rcp45/*p6Tmean*.rst"))
anp_tmean6 <- as.data.frame(raster::extract(tmean6, coor))
names(anp_tmean6)
colnames(anp_tmean6)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                        "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
prec2 <-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/PrecipitacionCNRMCM5_rcp45/*p2prec*.rst"))
...
prec3<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/PrecipitacionCNRMCM5_rcp45/*p3prec*.rst"))
...
prec4<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/PrecipitacionCNRMCM5_rcp45/*p4prec*.rst"))
...
prec5<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/PrecipitacionCNRMCM5_rcp45/*p5prec*.rst"))
...
prec6<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/PrecipitacionCNRMCM5_rcp45/*p6prec*.rst"))
...
prec4<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/PrecipitacionGFDL_CM3_rcp45/*p4prec*.rst"))
anp_prec4 <- as.data.frame(raster::extract(prec4, coor))
names(anp_prec4)
colnames(anp_prec4)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
prec5<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/PrecipitacionGFDL_CM3_rcp45/*p5prec*.rst"))
anp_prec5 <- as.data.frame(raster::extract(prec5, coor))
names(anp_prec5)
colnames(anp_prec5)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
prec6<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/PrecipitacionGFDL_CM3_rcp45/*p6prec*.rst"))
anp_prec6 <- as.data.frame(raster::extract(prec6, coor))
names(anp_prec6)
colnames(anp_prec6)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
prec4<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/PrecipitacionHADGEM2_ES_rcp45/*p4prec*.rst"))
anp_prec4 <- as.data.frame(raster::extract(prec4, coor))
names(anp_prec4)
colnames(anp_prec4)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
prec5<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/PrecipitacionHADGEM2_ES_rcp45/*p5prec*.rst"))
anp_prec5 <- as.data.frame(raster::extract(prec5, coor))
names(anp_prec5)
colnames(anp_prec5)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
prec6<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/PrecipitacionHADGEM2_ES_rcp45/*p6prec*.rst"))
anp_prec6 <- as.data.frame(raster::extract(prec6, coor))
names(anp_prec6)
colnames(anp_prec6)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
prec4<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/PrecipitacionMPI_ESM_LR_rcp45/*p4prec*.rst"))
anp_prec4 <- as.data.frame(raster::extract(prec4, coor))
names(anp_prec4)
colnames(anp_prec4)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
prec5<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/PrecipitacionMPI_ESM_LR_rcp45/*p5prec*.rst"))
anp_prec5 <- as.data.frame(raster::extract(prec5, coor))
names(anp_prec5)
colnames(anp_prec5)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
...
prec6<-stack(Sys.glob("E:/3.CONABIO-IBUNAM_CC/reporte_sep17/entrega_sep17_CNMA/capas/capas_g/tiff/PrecipitacionMPI_ESM_LR_rcp45/*p6prec*.rst"))
anp_prec6 <- as.data.frame(raster::extract(prec6, coor))
names(anp_prec6)
colnames(anp_prec6)<-c("Enero", "Febrero", "Marzo","Abril","Mayo", "Junio", "Julio",
                       "Agosto", "Septiembre","Octubre", "Noviembre", "Diciembre")
